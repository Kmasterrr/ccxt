...
class valr(Exchange):
    ...
    async def fetch_markets(self, params={}):
        ...
        # }]
        result = []
        markets = self.safe_value(response, [])
        for i in range(0, len(markets)):
            ...
            result.append({
                ...
                'precision': {
                    'amount': None,
                    'price': self.parse_number(self.parse_precision(self.safe_string(market, 'baseDecimalPlaces'))),
                },
                'limits': {
                    'leverage': {
                        'min': None,
    ...
    async def fetch_accounts(self, params={}):
        ...
        :param dict params: extra parameters specific to the valr api endpoint
    ...
    async def fetch_order(self, id, symbol=None, params={}):
        ...
        :param str|None symbol: not used by valr fetchOrder
        :param dict params: extra parameters specific to the valr api endpoint
