...
module.exports = class valr extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            'id': 'valr',
            'name': 'valr',
            'countries': [ 'ZA' ],
            // 1000 calls per minute = 16 calls per second = 1000ms / 16 = 62ms between requests
            'rateLimit': 62,
            'version': '1',
            'pro': true,
            'has': {
            ...
            'urls': {
                'referral': 'https://www.valr.com/invite/VAZVPJ8V',
                'logo': '',
                'api': {
            ...
            'api': { // https://github.com/ccxt/ccxt/blob/master/CONTRIBUTING.md#implicit-api-methods
                'exchange': {
                    'get': {
                        'markets': 1,
                    },
    ...
    async fetchMarkets (params = {}) {
        ...
        for (let i = 0; i < markets.length; i++) {
            ...
            result.push ({
                ...
                'precision': {
                    'amount': undefined,
                    'price': this.parseNumber (this.parsePrecision (this.safeString (market, 'baseDecimalPlaces'))),
                },
                'limits': {
                    'leverage': {
                        'min': undefined,
    ...
    async fetchOrder (id, symbol = undefined, params = {}) {
         ...
         * @param {string|undefined} symbol not used by valr fetchOrder
         * @param {object} params extra parameters specific to the valr api endpoint
